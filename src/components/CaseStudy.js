...
function CaseStudy() {
    return(
        <div className="flex flex-col  items-center h-[340vh] lg:h-[200vh] pt-16 overflow-x-hidden">
            ...
            <div className="mt-12 ">
                <div className="flex lg:flex-row flex-col-reverse lg:w-[65vw] lg:h-[50vh] w-[90vw]">
                 ...
                 <div className="flex lg:flex-row flex-col lg:w-[65vw] w-[90vw] lg:h-[50vh] mt-36">
                 ...
                 <div className="flex lg:flex-row flex-col-reverse lg:w-[65vw] w-[90vw] lg:h-[50vh] mt-36">
